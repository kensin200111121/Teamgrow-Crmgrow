export const environment = {
  isSspa: true,
  production: true,
  api: 'https://api.crmgrow.com/app/',
  automation_api: 'https://automation.crmgrow.com/app/',
  server: 'https://api.crmgrow.com',
  website: 'https://media.view-content.com',
  ...
  pageBuilder: 'https://pages.theredx.com',
  ...
  VORTEX_BASE: 'https://vortex.theredx.com/',
  VORTEX_IDENTITY_BASE: 'https://identity.theredx.com/api',
  Vortex_Scheduler: 'scheduler.theredx.com',
  AGENTFIRE: 'https://myaccount.agentfire.com/login',
  SENTRY_DSN:
    'https://ea53c7fc6c8a442eb0f3a260be98852c@o4504722907791360.ingest.sentry.io/4505587401490432',
  envMode: 'prod' // 'dev', 'stage', 'prod'
};
