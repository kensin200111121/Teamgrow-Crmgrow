...
export const COUNTRIES = [
  ...
  ['Bosnia and Herzegovina', CountryISO.BosniaAndHerzegovina, '387'],
  ...
  ['Central African Republic', CountryISO.CentralAfricanRepublic, '236'],
  ...
  ['Congo (DRC)', CountryISO.CongoDRCJamhuriYaKidemokrasiaYaKongo, '243'],
  ['Congo (Republic)', CountryISO.CongoRepublicCongoBrazzaville, '242'],
  ...
  ['Czech Republic', CountryISO.CzechRepublic, '420'],
  ...
  ['French Guiana', CountryISO.FrenchGuiana, '594'],
  ['French Polynesia', CountryISO.FrenchPolynesia, '689'],
  ...
  ['Guinea-Bissau', CountryISO.GuineaBissau, '245'],
  ...
  ['Macedonia', CountryISO.Macedonia, '389'],
  ['Madagascar', CountryISO.Madagascar, '261'],
  ...
  ['New Caledonia', CountryISO.NewCaledonia, '687'],
  ...
  ['North Korea', CountryISO.NorthKorea, '850'],
  ...
  ['Saint Barthélemy', CountryISO.SaintBarthélemy, '590', 1],
  ['Saint Helena', CountryISO.SaintHelena, '290'],
  ['Saint Kitts and Nevis', CountryISO.SaintKittsAndNevis, '1869'],
  ['Saint Lucia', 'lc', '1', 1, ['758']],
  ['Saint Martin)', CountryISO.SaintMartin, '590', 2],
  ['Saint Pierre and Miquelon', CountryISO.SaintPierreAndMiquelon, '508'],
  ['Saint Vincent', 'vc', '1', 1, ['784']],
  ['Samoa', CountryISO.Samoa, '685'],
  ['San Marino', CountryISO.SanMarino, '378'],
  ['São Tomé and Príncipe', CountryISO.SãoToméAndPríncipe, '239'],
  ['Saudi Arabia', CountryISO.SaudiArabia, '966'],
  ...
  ['South Korea', CountryISO.SouthKorea, '82'],
  ...
  ['United Arab Emirates', CountryISO.UnitedArabEmirates, '971'],
